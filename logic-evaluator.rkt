...
(define (execute exp)
  (apply-in-underlying-scheme (eval-in-underlying-scheme (predicate exp) user-initial-environment)  ;; changed to not conflict with eval defined in evaluator.rkt
                              (args exp)))
